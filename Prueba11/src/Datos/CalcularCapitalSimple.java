 ...
 * @author gonzalo
 */
public class CalcularCapitalSimple extends javax.swing.JPanel {

    /**
     * Creates new form CalcularCapital
     */
    public CalcularCapitalSimple() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Ingrese el interes:");

        jLabel4.setText("Ingrese el tiempo:");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(layout.createSequentialGroup()
                                .addGap(6, 6, 6)
                                .addComponent(jTextRsultado, javax.swing.GroupLayout.DEFAULT_SIZE, 221, Short.MAX_VALUE))
    ...
    private void btnCalcularMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnCalcularMouseClicked
       ...
       // formula para calcular el capital simple
        double capital = monto /(1 + tasaInteres* tiempo);
       
        jTextRsultado.setText(String.format("%.2f", capital));
