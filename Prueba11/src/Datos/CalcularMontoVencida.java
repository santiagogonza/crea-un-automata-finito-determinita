 ...
 * @author gonzalo
 */
public class CalcularMontoVencida extends javax.swing.JPanel {

    /**
     * Creates new form CalcularValorPresente
     */
    public CalcularMontoVencida() {
        initComponents();
    }
    ...
    private void initComponents() {
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(jTexTiempo, javax.swing.GroupLayout.PREFERRED_SIZE, 164, javax.swing.GroupLayout.PREFERRED_SIZE))))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(62, 62, 62)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel3)
                    .addComponent(jTexInteres, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
       // formula para calcular el monto vencida
        ...
        // Calcular el valor del monto usando la fórmula
        double monto = anualidad * ((Math.pow(1 + tasaInteres, tiempo) - 1) / tasaInteres);

        // Mostrar el resultado en el campo de texto de resultado
        jTexResultado.setText(String.format("%.2f", monto));
